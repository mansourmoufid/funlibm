...
static const float pi_lo1_float = 1.509957883172319270670413970947265625e-7f ;
static const float pi_lo2_float = 1.07806059069484767853897011491426383145153522491455e-14f ;
...
static const double pi_lo1_double = 1.2246467991473529606547311478922074134605154738069e-16 ;
static const double pi_lo2_double = 2.16571334784382806216850328780792564845368713263767e-32 ;
...
#define pi_lo1(T) \
    _Generic((T){0}, \
        float: pi_lo1_float, \
        double: pi_lo1_double \
    )
#define pi_lo2(T) \
    _Generic((T){0}, \
        float: pi_lo2_float, \
        double: pi_lo2_double \
    )
...
static const float twopi_lo1_float = 3.01991576634463854134082794189453125e-7f ;
static const float twopi_lo2_float = 2.1561211813896953570779402298285276629030704498291e-14f ;
...
static const double twopi_lo1_double = 2.4492935982947059213094622957844148269210309476138e-16 ;
static const double twopi_lo2_double = 4.3314266956876561243370065756158512969073742652753e-32 ;
...
#define twopi_lo1(T) \
    _Generic((T){0}, \
        float: twopi_lo1_float, \
        double: twopi_lo1_double \
    )
#define twopi_lo2(T) \
    _Generic((T){0}, \
        float: twopi_lo2_float, \
        double: twopi_lo2_double \
    )
...
static const float pi_2_lo1_float = 7.549789415861596353352069854736328125e-8f ;
static const float pi_2_lo2_float = 5.3903029534742383926948505745713191572576761245728e-15f ;
...
static const double pi_2_lo1_double = 6.1232339957367648032736557394610370673025773690344e-17 ;
static const double pi_2_lo2_double = 1.08285667392191403108425164390396282422684356631883e-32 ;
...
#define pi_2_lo1(T) \
    _Generic((T){0}, \
        float: pi_2_lo1_float, \
        double: pi_2_lo1_double \
    )
#define pi_2_lo2(T) \
    _Generic((T){0}, \
        float: pi_2_lo2_float, \
        double: pi_2_lo2_double \
    )
...
static const float inv_pi_lo1_float = 1.284127648659705300815403461456298828125e-8f ;
static const float inv_pi_lo2_float = 1.46854773981577749284582745659122338111046701669693e-16f ;
...
static const double inv_pi_lo1_double = 3.5832474556075334976310570451294471661723173316373e-17 ;
static const double inv_pi_lo2_double = 5.090832193749854671564015787231669243148620866645e-33 ;

#define inv_pi(T) \
    _Generic((T){0}, \
        float: inv_pi_float, \
        double: inv_pi_double \
    )
#define inv_pi_hi(T) \
    _Generic((T){0}, \
        float: inv_pi_hi_float, \
        double: inv_pi_hi_double \
    )
#define inv_pi_lo(T) \
    _Generic((T){0}, \
        float: inv_pi_lo_float, \
        double: inv_pi_lo_double \
    )
#define inv_pi_lo1(T) \
    _Generic((T){0}, \
        float: inv_pi_lo1_float, \
        double: inv_pi_lo1_double \
    )
#define inv_pi_lo2(T) \
    _Generic((T){0}, \
        float: inv_pi_lo2_float, \
        double: inv_pi_lo2_double \
    )
...
static const float inv_2pi_lo1_float = 6.420638243298526504077017307281494140625e-9f ;
static const float inv_2pi_lo2_float = 7.3427386990788874642291372829561169055523350834846e-17f ;
...
static const double inv_2pi_lo1_double = 1.79162372780376674881552852256472358308615866581866e-17 ;
static const double inv_2pi_lo2_double = 2.5454160968749273357820078936158346215743104333225e-33 ;

#define inv_2pi(T) \
    _Generic((T){0}, \
        float: inv_2pi_float, \
        double: inv_2pi_double \
    )
#define inv_2pi_hi(T) \
    _Generic((T){0}, \
        float: inv_2pi_hi_float, \
        double: inv_2pi_hi_double \
    )
#define inv_2pi_lo(T) \
    _Generic((T){0}, \
        float: inv_2pi_lo_float, \
        double: inv_2pi_lo_double \
    )
#define inv_2pi_lo1(T) \
    _Generic((T){0}, \
        float: inv_2pi_lo1_float, \
        double: inv_2pi_lo1_double \
    )
#define inv_2pi_lo2(T) \
    _Generic((T){0}, \
        float: inv_2pi_lo2_float, \
        double: inv_2pi_lo2_double \
    )
...
static const float inv_pi_2_lo1_float = 2.56825529731941060163080692291259765625e-8f ;
static const float inv_pi_2_lo2_float = 2.9370954796315549856916549131824467622209340333939e-16f ;
...
static const double inv_pi_2_lo1_double = 7.1664949112150669952621140902588943323446346632746e-17 ;
static const double inv_pi_2_lo2_double = 1.018166438749970934312803157446333848629724173329e-32 ;

#define inv_pi_2(T) \
    _Generic((T){0}, \
        float: inv_pi_2_float, \
        double: inv_pi_2_double \
    )
#define inv_pi_2_hi(T) \
    _Generic((T){0}, \
        float: inv_pi_2_hi_float, \
        double: inv_pi_2_hi_double \
    )
#define inv_pi_2_lo(T) \
    _Generic((T){0}, \
        float: inv_pi_2_lo_float, \
        double: inv_pi_2_lo_double \
    )
#define inv_pi_2_lo1(T) \
    _Generic((T){0}, \
        float: inv_pi_2_lo1_float, \
        double: inv_pi_2_lo1_double \
    )
#define inv_pi_2_lo2(T) \
    _Generic((T){0}, \
        float: inv_pi_2_lo2_float, \
        double: inv_pi_2_lo2_double \
    )
